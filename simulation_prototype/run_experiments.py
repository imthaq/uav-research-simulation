...
def main():
    ...
    parser.add_argument("--run-level-output", "--summary-output", dest="run_level_output",
                         default="results/results_summary.csv",
    ...
    parser.add_argument("--scenario-summary-output", default="results/scenario_summary.csv",
                         help="Scenario-level statistical summary (mean/median/stdev/min/max/"
                              "95% CI per metric, aggregated across trials)")
    parser.add_argument("--metadata-output", default="results/experiment_metadata.json",
