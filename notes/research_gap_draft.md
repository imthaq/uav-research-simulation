...
Research Gap : The research has to sacrifice the generalizability for the  model to work accurately which is of course a limitation and we could extend our research by deep diving more into the concept of making our UAV more general in handling different scenarios, rather than focusing on the broader aspect of making it more general we can start from small different scenarios and extending it further without affecting the effectiveness of the model. 
